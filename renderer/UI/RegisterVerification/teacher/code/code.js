...
document.addEventListener('DOMContentLoaded', () => {
	...
	/**
	 * Validates the verification code entered by the user and sends a POST request to verify the teacher authentication.
	 * Retrieves necessary data from the local store, constructs a FormData object with user information and profile picture,
	 * and sends a POST request to the server to verify the teacher authentication.
	 * If the verification fails, updates the UI accordingly, including displaying the number of tries left.
	 * If the verification is successful, sets user information in the local store, sends a signal to the main process to indicate successful verification, and clears the verification process.
	 */
	...
	/**
	 * Sends a request to reset teacher verification status.
	 * Retrieves the school and email from the local store, constructs a request object,
	 * and sends a POST request to the server to reset the teacher verification.
	 * If the reset is successful, removes email, tempUsername, and tempProfilePic from the local store.
	 */
