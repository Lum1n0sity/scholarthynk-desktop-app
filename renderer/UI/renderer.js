...
const {
	fsBackend,
	i18next,
	ipcRenderer: rendererJSIpcRenderer,
	Store: storeJSRenderer,
	config: configRenderer
} = require(path.join(rootPath, 'utils.js'));
...
document.addEventListener('DOMContentLoaded', async () => {
	...
	/**
	 * Updates the language of UI elements with data-i18n attributes.
	 * Iterates through all elements with a data-i18n attribute and updates their content based on the translation key.
	 * Supports different attributes such as 'textContent' and 'placeholder' for updating different types of content.
	 */
